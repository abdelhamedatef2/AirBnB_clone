...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """nothing happen when receiving an empty line."""
        pass
    ...
    def do_show(self, arg):
        ...
        Display str represent class instance of given id.
        """
        argl = parse(arg)
        objdict = storage.all()
        if len(argl) == 0:
    ...
    def do_all(self, arg):
        ...
        Display str represent of all instances of given class.
        If ther no class specified displays all instantiated objs."""
        argl = parse(arg)
